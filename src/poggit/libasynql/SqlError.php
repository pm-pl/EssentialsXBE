...
class SqlError extends RuntimeException{
	/**
	 * Returned by {@link \src\Vecnavium\SkyBlocksPM\libs\poggit\libasynql\SqlError::getStage() getStage()}, indicating that an error occurred while connecting to the database
	 */
	public const STAGE_CONNECT = "CONNECT";
	/**
	 * Returned by {@link \src\Vecnavium\SkyBlocksPM\libs\poggit\libasynql\SqlError::getStage() getStage()}, indicating that an error occurred while preparing the query
	 */
	public const STAGE_PREPARE = "PREPARE";
	/**
	 * Returned by {@link \src\Vecnavium\SkyBlocksPM\libs\poggit\libasynql\SqlError::getStage() getStage()}, indicating that an error occurred while the SQL backend is executing the query
	 */
	public const STAGE_EXECUTE = "EXECUTION";
	/**
	 * Returned by {@link \src\Vecnavium\SkyBlocksPM\libs\poggit\libasynql\SqlError::getStage() getStage()}, indicating that an error occurred while handling the response of the query
	 */
