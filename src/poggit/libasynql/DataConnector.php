...
interface DataConnector{
	 ...
	 * @param string  $queryName the {@link GenericPreparedStatement} query name
	 * @param mixed[] $args      the variables as defined in the {@link GenericPreparedStatement}
	 * @return Generator<mixed, \src\Vecnavium\SkyBlocksPM\libs\poggit\libasynql\libs\SOFe\AwaitGenerator\Await::RESOLVE|\src\Vecnavium\SkyBlocksPM\libs\poggit\libasynql\libs\SOFe\AwaitGenerator\Await::REJECT, mixed, array{array[], SqlColumnInfo[]}>
	 */
